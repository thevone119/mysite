...
class XP1024Movie(models.Model):
    ...
    pub_down_url =  models.CharField(blank=True, null=True)  # 下载的url地址
    ...
    pub_img_count = models.IntegerField(blank=True, null=True)  # 多少张图
    pub_font_url=  models.CharField(max_length=256, blank=True, null=True)  # 字幕地址
